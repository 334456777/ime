# SRT Intelligent Correction Tool

## Purpose

A specialized tool developed for video editing work, primarily solving pinyin input error problems in SRT subtitle files. During video editing, subtitles are often generated through speech recognition or manual input, frequently containing pinyin errors such as "泰尔" instead of "太傻", "私密度" instead of "四密度". These errors affect subtitle professionalism and readability if not corrected.
